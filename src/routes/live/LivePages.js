    ...
    return (
        <div className="about-pages">
            ...
            <div className="list-news-event">
                {live.map((item) => (
                    <div key={item.index}>
                        <iframe width="1440" height="780" src={item.attributes.video_live} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                    </div>
                ))}
